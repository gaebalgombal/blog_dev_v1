...
export const Navbar = ({ params: { lang } }: Props) => {
    ...
    useEffect(() => {
        ...
        if (after === "dark") {
            setDarkActive((prev) => true);
            document.body.classList.add("darkmode");
        } else if (after === "light") {
            setDarkActive((prev) => false);
            document.body.classList.remove("darkmode");
        }
    }, []);
    ...
    let lightMode = classNames({
        ...
        [navbarStyles.active]: isDarkActive ? false : true,
    });

    let darkMode = classNames({
        [navbarStyles.icons_wrapper]: true,
        [navbarStyles.active]: isDarkActive ? true : false,
        [navbarStyles.dark_mode]: isDarkActive ? true : false,
    });
        ...
        <nav className={layoutStyles.ly_navbar}>
            <div className={navbarStyles.bl_navbar}>
                ...
                <ul>
                    ...
                    <li>
                        <button
                            className={navbarStyles.dropdown_button}
                        ...
                        >
                            <div>
                                ...
                                >
                                    <LangLink
                                        params={{ key: `kr`, value: "한국어" }}
                                    ></LangLink>
                                    <LangLink
                                        params={{ key: `en`, value: "English" }}
                                    ></LangLink>
                                </div>
                            </div>
                        </button>
